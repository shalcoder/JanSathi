                ...
                <SignIn
                    appearance={{
                        ...
                        elements: {
                            ...
                            formFieldInput: 'bg-input/50 border-border text-foreground rounded-xl py-3 px-4 focus:ring-2 focus:ring-primary/20 focus:border-primary/50 transition-all placeholder:text-muted h-12',
