  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-[family-name:var(--font-outfit)] relative overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-4xl mx-auto px-6 py-20 relative z-10 flex flex-col items-center text-center mt-8">
        <div className="w-20 h-20 bg-purple-500/10 border border-purple-500/20 rounded-3xl flex items-center justify-center mb-8 shadow-2xl shadow-purple-500/20">
        ...
        <p className="text-xl text-secondary-foreground leading-relaxed mb-12 max-w-2xl bg-secondary/30 py-2 px-6 rounded-full border border-border/50">
          Automated Agent Interaction Guidelines
        </p>

        <div className="w-full max-w-2xl p-8 bg-card/60 backdrop-blur-xl border border-border/50 rounded-3xl shadow-xl text-left hover:border-purple-500/30 transition-colors">
           <h3 className="font-bold text-xl mb-3 text-foreground flex items-center gap-3">
             <CheckCircle2 className="w-6 h-6 text-purple-500" />
             Hackathon Pilot Phase
           </h3>
           <p className="text-base text-secondary-foreground leading-relaxed">
             By accessing JanSathi via the Dashboard or the Toll-Free IVR number, you agree to our terms of automated agent interaction. The full legal terms mapping API usage and toll-free compliance will be provided prior to scaling beyond the hackathon pilot phase.
           </p>
        </div>
